...
//		File file = new File(F);
		//String string = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Live><Channel channelid = \"C01\"><title>Star plus</title><desc>this is start plus tv</desc><genre>Entertainment</genre><country>INDIA</country><region>ALL</region><language>Hindi</language><imageURL>www.google.com</imageURL><channelURL>www.s3.com</channelURL><packagelist><packageID>P01</packageID></packagelist></Channel></Live>";
		//String string = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Live><Channel channelid = \"C01\"><title>Star plus</title><desc>this is start plus tv</desc><genre>Entertainment</genre><country>INDIA</country><region>ALL</region><language>Hindi</language><imageURL>www.google.com</imageURL><channelURL>www.s3.com</channelURL><packagelist><packageID>P01</packageID></packagelist></Channel></Live>";
		
		//String string = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><EPG><programme programID=\"C02P01\"><title>Sunaina</title><desc>This show revolves around a 15 year old girl called Sunaina and the crazy world she lives in. A dysfunctional family, a crazy set of friends, and a school where you break all the rules.</desc><start>20160428000000</start><end>20160428000000</end><genre>Anime</genre><duration>60</duration><country>INDIA</country><rating>A</rating><credits><director>Mark Steven Johnson</director><actor>Nicolas Cage</actor><writer>Sam Elliott</writer><producer>Calgary Stampede</producer></credits><language>Hindi</language><ChannelID>C02</ChannelID></programme></EPG>";
       ...
       // System.out.println(cls);
		...
		//ob = mUnmarshaller.unmarshal(new File(F));l
